  ...
  return (
    <div className='descriptionbox'>
        <div className="descriptionbox-navigator">
            ...
            <div className="fade">Reviews (122)</div>
        </div>
        <div className="descriptionbox-description">
          ...
          <p>E-commerce websites typically display products or services a detailed descriptions, images, prices, and any available var (e.g., sizes, colors). Each product usually has its dedi with relevant information.</p>  
        </div>
    </div>
  )
}
